package jetbrains.mps.editor.richtext.runtime;
  ...
  protected List<SubstituteAction> createActions() {
    ...
    result = ListSequence.fromList(result).where(new IWhereFilter<SubstituteAction>() {
      public boolean accept(SubstituteAction action) {
        ...
        SNode linkDeclaration = ListSequence.fromList(SLinkOperations.getTargets(SConceptOperations.findConceptDeclaration("jetbrains.mps.editor.richtext.structure.Text"), "linkDeclaration", true)).first();
