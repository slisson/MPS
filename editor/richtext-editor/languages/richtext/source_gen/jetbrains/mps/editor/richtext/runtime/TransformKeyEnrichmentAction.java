...
public class TransformKeyEnrichmentAction extends AbstractNodeSubstituteAction {
  ...
  protected SNode doSubstitute(String pattern) {
    ...
    Text_Behavior.call_normalizeStructure_5500395430674470428(SNodeOperations.getAncestor(richNode, "jetbrains.mps.editor.richtext.structure.Text", false, false));
    return richNode;
  }
