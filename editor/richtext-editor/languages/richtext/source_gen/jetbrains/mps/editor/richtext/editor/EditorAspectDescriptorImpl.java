...
public class EditorAspectDescriptorImpl implements EditorAspectDescriptor {
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0a = new String[]{"jetbrains.mps.editor.richtext.structure.Text", "jetbrains.mps.editor.richtext.structure.Word"};
}
