...
public class Text_Behavior {
  public static void init(SNode thisNode) {
    SLinkOperations.addNewChild(thisNode, "words", "jetbrains.mps.editor.richtext.structure.Word");
  }
  ...
  public static void call_normalizeStructure_5500395430674470428(SNode thisNode) {
    ...
    for (SNode word : ListSequence.fromList(SLinkOperations.getTargets(thisNode, "words", true))) {
      if (SNodeOperations.isInstanceOf(word, "jetbrains.mps.editor.richtext.structure.Word") && SNodeOperations.isInstanceOf(ListSequence.fromList(newWords).last(), "jetbrains.mps.editor.richtext.structure.Word")) {
        // Merge two consecutive 'Word's 
        String leftText = SPropertyOperations.getString(SNodeOperations.cast(ListSequence.fromList(newWords).last(), "jetbrains.mps.editor.richtext.structure.Word"), "escapedValue");
        String rightText = SPropertyOperations.getString(SNodeOperations.cast(word, "jetbrains.mps.editor.richtext.structure.Word"), "escapedValue");
        if (leftText == null) {
          leftText = "";
        }
        if (rightText == null) {
        ...
        SPropertyOperations.set(SNodeOperations.cast(ListSequence.fromList(newWords).last(), "jetbrains.mps.editor.richtext.structure.Word"), "escapedValue", leftText + "" + rightText);

      } else {
        // Always a 'Word' between two embedded nodes 
        if (!(SNodeOperations.isInstanceOf(word, "jetbrains.mps.editor.richtext.structure.Word")) && !(SNodeOperations.isInstanceOf(ListSequence.fromList(newWords).last(), "jetbrains.mps.editor.richtext.structure.Word"))) {
          ListSequence.fromList(newWords).addElement(SConceptOperations.createNewNode("jetbrains.mps.editor.richtext.structure.Word", null));
        }
        // Everything is fine 
    ...
    // End with a word 
    if (!(SNodeOperations.isInstanceOf(ListSequence.fromList(newWords).last(), "jetbrains.mps.editor.richtext.structure.Word"))) {
      ListSequence.fromList(newWords).addElement(SConceptOperations.createNewNode("jetbrains.mps.editor.richtext.structure.Word", null));
    }
  ...
  public static boolean call_isNormalized_842294157794126645(SNode thisNode) {
    ...
    // starts with a 'Word' 
    if (!(SNodeOperations.isInstanceOf(ListSequence.fromList(SLinkOperations.getTargets(thisNode, "words", true)).first(), "jetbrains.mps.editor.richtext.structure.Word"))) {
      return false;
    }
    // ends with a 'Word' 
    if (!(SNodeOperations.isInstanceOf(ListSequence.fromList(SLinkOperations.getTargets(thisNode, "words", true)).last(), "jetbrains.mps.editor.richtext.structure.Word"))) {
      return false;
    }
    ...
    for (SNode word : ListSequence.fromList(SLinkOperations.getTargets(thisNode, "words", true))) {
      ...
      if (!(SNodeOperations.isInstanceOf(word, "jetbrains.mps.editor.richtext.structure.Word")) ^ SNodeOperations.isInstanceOf(SNodeOperations.getNextSibling(word), "jetbrains.mps.editor.richtext.structure.Word")) {
        return false;
      }
    }
