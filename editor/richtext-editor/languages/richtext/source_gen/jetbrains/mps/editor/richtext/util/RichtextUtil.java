...
import jetbrains.mps.editor.richtext.runtime.EnrichmentInfo;
...
public class RichtextUtil {
      ...
      public Iterable<SNode> translate(Language lang) {
        return ListSequence.fromList(SModelOperations.getNodes(getStructureModel(lang), "jetbrains.mps.lang.structure.structure.ConceptDeclaration")).where(new IWhereFilter<SNode>() {
          public boolean accept(SNode concept) {
            return SConceptOperations.isSubConceptOf(((SNode) concept), "jetbrains.mps.editor.richtext.structure.IWord");
          }
        });
      }
  ...
  public static void userTriggeredEnrichment(EditorContext editorContext, SNode word) {
    ...
    Text_Behavior.call_ensureNormalized_3868187941957822880(SNodeOperations.getAncestor(word, "jetbrains.mps.editor.richtext.structure.Text", false, false));
  }
  ...
  public static SNode destructNode(SNode node, final EditorContext editorContext) {
    ...
    SNode word = SNodeOperations.as(SNodeOperations.getPrevSibling(node), "jetbrains.mps.editor.richtext.structure.Word");
    if ((word != null)) {
      Word_Behavior.call_setText_2008781830388272163(word, Word_Behavior.call_getText_257181264606026343(word) + descructedText);
    } else {
      word = SNodeOperations.as(SNodeOperations.getNextSibling(node), "jetbrains.mps.editor.richtext.structure.Word");
      if ((word != null)) {
        Word_Behavior.call_setText_2008781830388272163(word, descructedText + Word_Behavior.call_getText_257181264606026343(word));
      } else {
        word = SConceptOperations.createNewNode("jetbrains.mps.editor.richtext.structure.Word", null);
