...
public class RichtextSelection extends AbstractSelection {
  ...
  public void selectLeftRight(boolean left) {
    ...
    if (SNodeOperations.isInstanceOf(endNode, "de.slisson.mps.richtext.structure.Word") && Word_Behavior.call_isValidCursorPosition_6973228588407182986(SNodeOperations.cast(endNode, "de.slisson.mps.richtext.structure.Word"), newEndTextPos)) {
      ...
      if (SNodeOperations.isInstanceOf(newEndNode, "de.slisson.mps.richtext.structure.Word")) {
        newEndTextPos = (left ? Word_Behavior.call_getText_257181264606026343(SNodeOperations.cast(newEndNode, "de.slisson.mps.richtext.structure.Word")).length() - 1 : 1);
      }
  ...
  public void selectLocalHomeEnd(boolean left) {
    ...
    int newEndTextPos = (left ? myEndTextPos - 1 : myEndTextPos + 1);
    if (SNodeOperations.isInstanceOf(endNode, "de.slisson.mps.richtext.structure.Word") && Word_Behavior.call_isValidCursorPosition_6973228588407182986(SNodeOperations.cast(endNode, "de.slisson.mps.richtext.structure.Word"), newEndTextPos)) {
      SNode endWord = SNodeOperations.cast(endNode, "de.slisson.mps.richtext.structure.Word");
  ...
  public SNode getFirstWordNodeLeft(SNode node) {
    ...
    if (SNodeOperations.isInstanceOf(node, "de.slisson.mps.richtext.structure.Word")) {
      return SNodeOperations.cast(node, "de.slisson.mps.richtext.structure.Word");
    }
  ...
  public TextPosition deleteSelected() {
    ...
    SNode text = SNodeOperations.as(SNodeOperations.getParent(ListSequence.fromList(selectedNodes).first()), "de.slisson.mps.richtext.structure.Text");
    ...
    for (int i = 0; i < selectedNodes.size(); ++i) {
      ...
      if (SNodeOperations.isInstanceOf(node, "de.slisson.mps.richtext.structure.Word") && (isFirst || isLast)) {
        SNode wordNode = SNodeOperations.cast(node, "de.slisson.mps.richtext.structure.Word");
        int removeStart = 0;
  ...
  public List<SNode> getSelectedWords() {
    ...
    SNode firstWord = SNodeOperations.as(ListSequence.fromList(nodes).first(), "de.slisson.mps.richtext.structure.Word");
    SNode lastWord = SNodeOperations.as(ListSequence.fromList(nodes).last(), "de.slisson.mps.richtext.structure.Word");
    if (myLeftToRight) {
      if ((lastWord != null)) {
  ...
  public void copySelectedNodes() {
    ...
    if (ListSequence.fromList(words).count() == 1 && SNodeOperations.isInstanceOf(ListSequence.fromList(words).getElement(0), "de.slisson.mps.richtext.structure.Word")) {
      CopyPasteUtil.copyTextToClipboard(Word_Behavior.call_getText_257181264606026343(SNodeOperations.cast(ListSequence.fromList(words).getElement(0), "de.slisson.mps.richtext.structure.Word")));
    } else {
  ...
  public SelectionInfo getSelectionInfo() throws SelectionStoreException {
    SelectionInfoImpl selectionInfo = new SelectionInfoImpl(this.getClass().getName(), PersistenceFacade.getInstance().createModuleReference("92d2ea16-5a42-4fdf-a676-c7604efe3504(de.slisson.mps.richtext)").getModuleName());
  ...
  public static RichtextSelection create(final jetbrains.mps.openapi.editor.cells.EditorCell startLeaf, final int startLeafTextPos, final jetbrains.mps.openapi.editor.cells.EditorCell endLeaf, final int endLeafCursorPos) {
    ...
    ModelAccess.instance().requireRead(new _Adapters._return_P0_E0_to_Runnable_adapter(new _FunctionTypes._return_P0_E0<RichtextSelection>() {
      public RichtextSelection invoke() {
        SNode commonParentText = SNodeOperations.getAncestor(getFirstCommonParentNode(startLeaf, endLeaf), "de.slisson.mps.richtext.structure.Text", true, false);
        ...
        int endTextPos = 0;
        if (SNodeOperations.isInstanceOf(endWord, "de.slisson.mps.richtext.structure.Word") && endLeaf instanceof EditorCell_Word) {
        ...
        int startTextPos = 0;
        if (SNodeOperations.isInstanceOf(startWord, "de.slisson.mps.richtext.structure.Word") && startLeaf instanceof EditorCell_Word) {
  ...
  public static SNode getParentTextNode(jetbrains.mps.openapi.editor.cells.EditorCell childCell) {
    return SNodeOperations.getAncestor(((SNode) childCell.getSNode()), "de.slisson.mps.richtext.structure.Text", false, false);
  }

  public static SNode getParentIWord(jetbrains.mps.openapi.editor.cells.EditorCell childCell) {
    return SNodeOperations.getAncestor(((SNode) childCell.getSNode()), "de.slisson.mps.richtext.structure.IWord", true, false);
  }
  ...
  public static SNode getParentIWord(jetbrains.mps.openapi.editor.cells.EditorCell childCell, SNode asDirectChildOf) {
    ...
    if (SNodeOperations.isInstanceOf(cellNode, "de.slisson.mps.richtext.structure.IWord") && SNodeOperations.getParent(cellNode) == asDirectChildOf) {
      return SNodeOperations.cast(cellNode, "de.slisson.mps.richtext.structure.IWord");
    }
    for (SNode ancestor : ListSequence.fromList(SNodeOperations.getAncestors(cellNode, null, false)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.isInstanceOf(it, "de.slisson.mps.richtext.structure.IWord");
      }
    })) {
      if (SNodeOperations.getParent(ancestor) == asDirectChildOf) {
        return SNodeOperations.cast(ancestor, "de.slisson.mps.richtext.structure.IWord");
      }
    }
    return null;
  }
  ...
  public static jetbrains.mps.openapi.editor.cells.EditorCell getParentIWordRootCell(jetbrains.mps.openapi.editor.cells.EditorCell anyChildCell) {
    ...
    while (parent != null && prevParent.getSNode() == parent.getSNode() || !(SNodeOperations.isInstanceOf(((SNode) prevParent.getSNode()), "de.slisson.mps.richtext.structure.IWord"))) {
      prevParent = parent;
