...
public class Text_Normalize_Intention implements IntentionFactory {
  ...
  public String getConcept() {
    return "de.slisson.mps.richtext.structure.Text";
  }
  ...
  public String getPersistentStateKey() {
    return "de.slisson.mps.richtext.intentions.Text_Normalize_Intention";
  }
  ...
  private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
    return (SNodeOperations.getAncestor(node, "de.slisson.mps.richtext.structure.Text", false, false) == null);
  }

  public SNodeReference getIntentionNodeReference() {
    return new SNodePointer("r:fa163aad-8c9b-4361-aa5e-88392679736a(de.slisson.mps.richtext.intentions)", "5500395430674355060");
  }
