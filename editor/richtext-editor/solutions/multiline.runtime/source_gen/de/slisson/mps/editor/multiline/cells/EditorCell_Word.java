...
public class EditorCell_Word extends EditorCell_Property {
  ...
  public String getCellId() {
    return check_xru0dp_a0a0a82(getParent(), this) + "_word" + myWordNum;
  }
  ...
  public void synchronizeViewWithModel() {
    check_xru0dp_a0a33(getParent(), this);
  }
  ...
  private static String check_xru0dp_a0a0a82(EditorCell_Multiline checkedDotOperand, EditorCell_Word checkedDotThisExpression) {
  ...
  private static void check_xru0dp_a0a33(EditorCell_Multiline checkedDotOperand, EditorCell_Word checkedDotThisExpression) {
    if (null != checkedDotOperand) {
