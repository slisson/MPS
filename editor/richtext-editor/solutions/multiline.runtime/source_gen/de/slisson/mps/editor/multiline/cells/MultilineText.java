...
public class MultilineText {
  ...
  public void setText(String newText) {
    ...
    this.myText = newText;
    if (neq_ua5mzx_a0g0l(newText, oldText)) {
  ...
  public void setWords(String[][] newWords) {
    ...
    myText = newText;
    myWords = newWords;
    if (neq_ua5mzx_a0f0r(newText, oldText)) {
      myChangeSupport.firePropertyChange(PROPERTY_TEXT, oldText, newText);
      myChangeSupport.firePropertyChange(PROPERTY_WORDS, oldWords, newWords);
    }
  }
  ...
  public void deleteWords(int from, int to) {
    ...
    Range<Integer> rangeToRemove = Range.between(from, to);
    Range<Integer> lineRange = Range.between(-1, -1);
    List<String> newLine = ListSequence.fromList(new ArrayList<String>());
    for (String[] line : oldWords) {
      lineRange = Range.between(lineRange.getMaximum() + 1, lineRange.getMaximum() + line.length);
      if (rangeToRemove.isOverlappedBy(lineRange) || lineRange.containsRange(rangeToRemove)) {
  ...
  private static boolean neq_ua5mzx_a0g0l(Object a, Object b) {
    return !((a != null ? a.equals(b) : a == b));
  }

  private static boolean neq_ua5mzx_a0f0r(Object a, Object b) {
    return !((a != null ? a.equals(b) : a == b));
  }
}
