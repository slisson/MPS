...
public class EditorAspectDescriptorImpl implements EditorAspectDescriptor {
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0a = new String[]{"jetbrains.mps.samples.richtext.structure.Document", "jetbrains.mps.samples.richtext.structure.EmbeddedCode", "jetbrains.mps.samples.richtext.structure.MultilineString", "jetbrains.mps.samples.richtext.structure.Paragraph"};
}
