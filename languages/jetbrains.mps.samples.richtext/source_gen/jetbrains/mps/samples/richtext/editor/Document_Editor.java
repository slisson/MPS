...
public class Document_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_7wjwco_c0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Document_Editor.paragraphListHandler_7wjwco_c0(node, "paragraph", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_paragraph");
    editorCell.setRole(handler.getElementRole());
    return editorCell;
  }

  private static class paragraphListHandler_7wjwco_c0 extends RefNodeListHandler {
    public paragraphListHandler_7wjwco_c0(SNode ownerNode, String childRole, EditorContext context) {
